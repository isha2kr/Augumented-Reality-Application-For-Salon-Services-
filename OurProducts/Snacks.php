...
<body>
	...
	<div class="categolis">
		<table>
			<tr>
				...
				<th><a href="Snacks.php" style="text-decoration: none;color: #040403;padding: 4px 12px;background-color: #24bfae;border-radius: 12px;">Facial</a></th>
	...
	<div style="padding: 15px 0px; font-size: 15px; margin: 0 auto; display: table; width: 98%;">
		<div>
		<?php 
			$getposts = mysqli_query($dbhandle,"SELECT * FROM products WHERE available >='1' AND item ='snack'  ORDER BY id DESC LIMIT 10") or die(mysql_error());
