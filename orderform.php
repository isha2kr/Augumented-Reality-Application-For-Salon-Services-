...
if (isset($_REQUEST['poid'])) {
	...
	$poid = mysqli_real_escape_string($dbhandle,$_REQUEST['poid']);
}else {
...
$getposts = mysqli_query($dbhandle,"SELECT * FROM products WHERE id ='$poid'") or die(mysql_error());
...
//triming name
	try {
		...
		// Check if email already exists
						...
						if(mysqli_query($dbhandle,"INSERT INTO orders (uid,pid,oplace,mobile,odate) VALUES ('$user','$poid','$_POST[address]','$_POST[mobile]','$d')")){
...
<body style="background-image: url(image/homebackgrndimg1.jpg);">
	...
	<div class="categolis">
		<table>
			<tr>
				<th>
					<a href="OurProducts/NoodlesCanned.php" style="text-decoration: none;color:#040403 ;padding: 4px 12px;background-color: #e6b7b8;border-radius: 12px;">Threading</a>
				</th>
				<th><a href="OurProducts/Seasonings.php" style="text-decoration: none;color: #040403;padding: 4px 12px;background-color: #e6b7b8;border-radius: 12px;">Hairstyle</a></th>
				<th><a href="OurProducts/Drinks.php" style="text-decoration: none;color: #040403;padding: 4px 12px;background-color: #e6b7b8;border-radius: 12px;">Nailart</a></th>
				<th><a href="OurProducts/Snacks.php" style="text-decoration: none;color: #040403;padding: 4px 12px;background-color: #e6b7b8;border-radius: 12px;">Facial</a></th>
				<th><a href="OurProducts/Sweets.php" style="text-decoration: none;color: #040403;padding: 4px 12px;background-color: #e6b7b8;border-radius: 12px;">Waxing</a></th>
			...
			<div>
				...
				<?php 
					if(isset($success_message)) {echo $success_message;
									...
									echo '<h3 style="color:#169E8F;font-size:45px;"> Payment</h3>';
						...
						<div>
							<form action="" method="POST" class="registration">
								...
								<h3 style="color:red;font-size:18px; padding: 5px;">Accepting CashOnDelivery Only</h3>
									...
									<div>
									<td>
											<input name="Date" required="required" type="number" min="1" class="password signupbox" placeholder="Date">
										</td>
									</div>
									<div>
										<td>
											<input name="Month" required="required" type="month" min="1" max="12" class="password signupbox" placeholder="Month">
										</td>
									</div>
									<div>
									<td>

									 <input name="Time" required="required" type="time" echo date("H:i", strtotime("04:25 PM")) class="password signupbox" placeholder="Time">
